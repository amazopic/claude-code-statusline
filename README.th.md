...
มิเตอร์ 5h / 7d รวมการนับถอยหลังแบบสดไปยังช่วงเวลาที่แต่ละหน้าต่างจะรีเซ็ต: `5h{1h 6m}: 1%` — หน้าต่าง 5 ชั่วโมงจะรีเซ็ตใน 1 ชั่วโมง 6 นาที; `7d{1d 2h}: 0%` — หน้าต่างรายสัปดาห์จะรีเซ็ตใน 1 วัน 2 ชั่วโมง คุณจะรู้เสมอว่าเมื่อไหร่ที่คุณจะกลับมาอยู่ที่ 0% ดังนั้นคุณสามารถจัดตารางงานหนักได้ทันทีหลังจากการรีเซ็ตและกระจายประสิทธิภาพการทำงานของคุณ แทนที่จะชนเพดานกลางงาน ขับเคลื่อนด้วย `rate_limits.*.resets_at` ที่ส่งโดย Claude Code; หากบิลด์ของคุณไม่ส่ง timestamp การรีเซ็ต มิเตอร์จะถอยกลับไปแสดงแบบธรรมดา `5h: 1%` อย่างนุ่มนวล
...
> 💡 `refreshInterval: 30` รันบรรทัดใหม่ทุก 30 วินาที แม้ในขณะที่เซสชันว่างอยู่ — ทำให้การนับถอยหลังการรีเซ็ต (`5h{1h 6m}`), ตัวติดตามเวลา และการพลิกค่าหลังรีเซ็ตยังคงทำงานสด 30 เป็นค่าเริ่มต้นที่เหมาะสม; 60 ประหยัดแบตเตอรี่กว่า; ละไว้เพื่อรีเฟรชเฉพาะตอนมีเหตุการณ์ (ข้อความใหม่จากผู้ช่วย, `/compact`, การสลับ vim)
...
| การนับถอยหลังการรีเซ็ตในมิเตอร์ลิมิต (`5h{1h 6m}`) | ❌ | ✅ |
...
### `5h{1h 6m}: 1%` หมายความว่าอะไร?

คุณใช้ไป 1% ของหน้าต่าง 5 ชั่วโมง และ `{1h 6m}` คือการนับถอยหลังแบบสด — หน้าต่างจะรีเซ็ตใน 1 ชั่วโมง 6 นาที (`7d{1d 2h}`: หน้าต่างรายสัปดาห์จะรีเซ็ตใน 1 วัน 2 ชั่วโมง) อ่านจาก `rate_limits.*.resets_at` ในทุกการเรนเดอร์ ไม่มี timestamp การรีเซ็ตในบิลด์ของคุณ? มิเตอร์จะถอยกลับไปแสดงแบบธรรมดา `5h: 1%`

### สเตตัสไลน์อัปเดตด้วยตัวเองไหม? การนับถอยหลัง `{1h 6m}` ของฉันดูเหมือนค้างอยู่
