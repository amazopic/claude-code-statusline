...
export const themes = [
  ...
  { id: 'hard-worker',     name: 'Hard Worker',     vibe: 'Heads-down productivity dashboard: abbreviated git (cmt/mdf/psh/pll), a gold effort marker, the session LOC you accepted, and the session cost — all at a glance.', palette: ['#DCBC02','#46DA46','#E2D200','#DC2626','#0E0E10'], group: 'Practical' },
