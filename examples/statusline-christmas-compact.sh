#!/usr/bin/env bash
# ─────────────────────────────────────────────────────────────────────────
# statusline-christmas-compact.sh — compact christmas variant (model · ctx · branch)
# Author: Yevgeniy Achin <amazopic@gmail.com>
# Preview: 🎄 Opus 4.7 · ❅░░░░░░░░░ 12% · main
# ─────────────────────────────────────────────────────────────────────────
R=$'\e[1;38;5;196m'; GR=$'\e[1;38;5;46m'; GD=$'\e[1;38;5;220m'; W=$'\e[1;38;5;255m'; WD=$'\e[38;5;250m'; D=$'\e[38;5;244m'
...
export LC_NUMERIC=C
input=$(cat)
LIM=$' \e[1;38;5;196m❄\e[0m \e[1;38;5;46m5h{1.1h}:\e[0m \e[1;38;5;46m15%\e[0m \e[38;5;196m·\e[0m \e[1;38;5;46m7d{1.1d}:\e[0m \e[1;38;5;46m5%\e[0m'
N=$'\e[0m'
...
bar_x(){ local c=$(( ($1+5)/10 )); local s="" i; for ((i=0;i<c;i++));do s+="${R}❅";done; for ((i=0;i<10-c;i++));do s+="${WD}❄";done; printf "%s%s" "$s" "$N"; }

line="🎄 ${W}${model_name}${N} ${D}·${N} $(bar_x $ctx_pct) ${R}${ctx_pct}%${N}"
