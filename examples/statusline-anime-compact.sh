#!/usr/bin/env bash
# ─────────────────────────────────────────────────────────────────────────
# statusline-anime-compact.sh — compact anime variant (model · ctx · branch)
# Author: Yevgeniy Achin <amazopic@gmail.com>
# Preview: ✨ Opus 4.7 · ♥░░░░░░░░░ 12% · 🌸 main
# ─────────────────────────────────────────────────────────────────────────
P=$'\e[1;38;5;213m'; PD=$'\e[38;5;218m'; M=$'\e[1;38;5;201m'; V=$'\e[1;38;5;177m'
...
export LC_NUMERIC=C
input=$(cat)
LIM=$' \e[1;38;5;200m✨\e[0m \e[1;38;5;213m5h{1h 6m}:\e[0m \e[1;38;5;200m15%\e[0m \e[1;38;5;199m✨\e[0m \e[1;38;5;213m7d{1d 2h}:\e[0m \e[1;38;5;200m5%\e[0m'
N=$'\e[0m'
...
bar_a(){ local c=$(( ($1+5)/10 )); local s="" i; for ((i=0;i<c;i++));do s+="${M}♥";done; for ((i=0;i<10-c;i++));do s+="${PD}♡";done; printf "%s%s" "$s" "$N"; }

line="${P}✨ ${V}${model_name}${N} 🌸 ${P}${ctx_pct}${PD}%${N} $(bar_a $ctx_pct)"
