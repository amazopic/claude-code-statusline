#!/usr/bin/env bash
# ─────────────────────────────────────────────────────────────────────────
# statusline-cat-compact.sh — compact cat variant (model · ctx · branch)
# Author: Yevgeniy Achin <amazopic@gmail.com>
# Preview: 🐱 Opus 4.7 · 🐾░░░░░░░░░ 12% · 🌿 main
# ─────────────────────────────────────────────────────────────────────────
O=$'\e[1;38;5;208m'; P=$'\e[1;38;5;213m'; W=$'\e[1;38;5;255m'; D=$'\e[38;5;244m'
...
export LC_NUMERIC=C
input=$(cat)
LIM=$' 🐾 \e[1;38;5;215m5h{1h 6m}:\e[0m \e[1;38;5;208m15%\e[0m \e[38;5;215m·\e[0m \e[1;38;5;215m7d{1d 2h}:\e[0m \e[1;38;5;208m5%\e[0m'
N=$'\e[0m'
...
bar_ct(){ local c=$(( ($1+5)/10 )); local s="" i; for ((i=0;i<c;i++));do s+="${O}🐾";done; for ((i=0;i<10-c;i++));do s+="${D}··";done; printf "%s%s" "$s" "$N"; }

line="🐱 ${W}${model_name}${N} ${D}·${N} $(bar_ct $ctx_pct) ${O}${ctx_pct}%${N}"
