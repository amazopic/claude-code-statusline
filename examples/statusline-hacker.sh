#!/usr/bin/env bash
# ─────────────────────────────────────────────────────────────────────────
# statusline-hacker.sh — Matrix-style green-on-black status line
#
# Preview:
#   [SYS] Opus 4.7 :: CTX=12% [|||-------] :: $0.42 :: ROOT@matrix#
# ─────────────────────────────────────────────────────────────────────────
set -uo pipefail
...
export LC_NUMERIC=C
input=$(cat)
LIM=$' \e[38;5;28m::\e[0m \e[1;38;5;46m5h{1.1h}\e[38;5;28m:\e[0m \e[1;38;5;46m15%\e[0m \e[38;5;28m::\e[0m \e[1;38;5;46m7d{1.1d}\e[38;5;28m:\e[0m \e[1;38;5;46m5%\e[0m'

GR=$'\e[1;38;5;46m'    # bright green
GRD=$'\e[38;5;28m'     # dim green
GRDD=$'\e[38;5;22m'    # very dim green
W=$'\e[1;38;5;255m'
N=$'\e[0m'
...
host=$(hostname -s 2>/dev/null || echo matrix)
...
line="${GRD}[${GR}SYS${GRD}]${N} ${W}${model_name}${N}"
line+=" ${GRD}::${N} ${GR}CTX${GRD}=${GR}${ctx_pct}%${N} $(bar_matrix "$ctx_pct")"
line+=" ${GRD}::${N} ${GR}\$${cost_fmt}${N}"
line+=" ${GRD}::${N} ${GR}ROOT${GRD}@${GR}${host}${GRD}#${N}"
