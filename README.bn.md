...
## 🎨 158 ready-made variants — একটি বেছে নিন আর শুরু করুন
...
### 🚗 Auto brands (আরও 15, top picks-এ `ferrari` অন্তর্ভুক্ত)
...
| থিমড প্রিসেট | ❌ | ✅ 79 থিম × 2 ভ্যারিয়েন্ট = **158 ready-made** |
...
1. **79টি থিমের** একটি বেছে নিন (মোট 158 ভ্যারিয়েন্ট) — `~/.claude/status-line.sh use <name>` ব্যবহার করুন অথবা স্ট্যান্ডঅ্যালোন স্ক্রিপ্টের জন্য [`examples/`](examples/) ব্রাউজ করুন।
