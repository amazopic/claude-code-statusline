...
> 💡 `refreshInterval: 30` সেশন নিষ্ক্রিয় থাকা অবস্থায়ও প্রতি 30 সেকেন্ডে লাইনটি পুনরায় চালায় — এটি reset countdown (`5h{1h 6m}`), time tracker এবং রিসেট-পরবর্তী পরিবর্তনগুলি লাইভ রাখে। 30 একটি যুক্তিসঙ্গত ডিফল্ট; 60 ব্যাটারি-সাশ্রয়ী; শুধুমাত্র ইভেন্টে (নতুন assistant মেসেজ, `/compact`, vim টগল) রিফ্রেশ করতে এটি বাদ দিন।
...
| limit মিটারে Reset countdown (`5h{1h 6m}`) | ❌ | ✅ |
...
আপনি 5-ঘণ্টার উইন্ডোর 1% ব্যবহার করেছেন, এবং `{1h 6m}` একটি লাইভ কাউন্টডাউন — উইন্ডোটি 1 ঘণ্টা 6 মিনিটে রিসেট হয় (`7d{1d 2h}`: সাপ্তাহিক উইন্ডো 1 দিন 2 ঘণ্টায় রিসেট হয়)। প্রতিটি রেন্ডারে `rate_limits.*.resets_at` থেকে পড়া হয়। আপনার বিল্ডে কোনো reset টাইমস্ট্যাম্প নেই? মিটারটি সাধারণ `5h: 1%`-এ ফিরে যায়।

### স্ট্যাটাস লাইন কি নিজে নিজে আপডেট হয়? আমার `{1h 6m}` কাউন্টডাউন জমে যাওয়া দেখাচ্ছে।
