...
## 🎨 164 biến thể dựng sẵn — chọn một cái và chạy
...
| Preset theo chủ đề | ❌ | ✅ 82 chủ đề × 2 biến thể = **164 dựng sẵn** |
...
1. Chọn một trong **82 chủ đề** (tổng cộng 164 biến thể) — dùng `~/.claude/status-line.sh use <name>` hoặc duyệt [`examples/`](examples/) để lấy các script độc lập.
